...
namespace FollowPeers.Models
{
    public class FollowPeersDBEntities :  DbContext 
    {
        ...
        public DbSet<AchievementLike> AchievementLikes { get; set; }
        public DbSet<Tag> Tags { get; set; }
        //public DbSet<EventUserProfile> EventUserProfilesJoin { get; set; }
        public DbSet<EventUserProfileJoin> EventUserProfileJoins { get; set; }
